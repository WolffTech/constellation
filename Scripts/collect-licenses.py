...
NOTICES = [
    ...
    ("sparkle", "Sparkle", "2.10.0", "MIT; bundled components (bspatch, ed25519, SHA-1) under compatible permissive licenses", "https://github.com/sparkle-project/Sparkle",
     "In-app updates, embedded as the prebuilt framework the Sparkle project publishes.",
     lambda: from_checkout("Sparkle")),
